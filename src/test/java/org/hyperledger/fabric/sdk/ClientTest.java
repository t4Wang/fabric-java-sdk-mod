...
public class ClientTest {
    ...
    public void testNewPeer() {
        try {
            Peer peer = hfclient.newPeer("peer_", "grpc://" + Constantss.URL_V + ":7051");
    ...
    public void testNewOrderer() {
        try {
            Orderer orderer = hfclient.newOrderer("xx", "grpc://" + Constantss.URL_V + ":5005");
    ...
    public void testGoodMockUser() throws Exception {
        ...
        Orderer orderer = hfclient.newOrderer("justMockme", "grpc://" + Constantss.URL_V + ":99"); // test mock should work.
