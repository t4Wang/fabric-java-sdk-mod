...
public class TLSCertGenTest {
    ...
    public void selfSignedTLSCertTest() throws Exception {
        ...
        TLSCertificateKeyPair serverCert = certBuilder.serverCert("" + Constantss.URL_V + "");
    ...
    private static class MockEndorser extends EndorserGrpc.EndorserImplBase {
        public void processProposal(FabricProposal.SignedProposal request,
                                    io.grpc.stub.StreamObserver<FabricProposalResponse.ProposalResponse> responseObserver) {
