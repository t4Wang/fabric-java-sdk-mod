...
public class PeerTest {
    ...
    public static void setupClient() {
        try {
            ...
            peer = hfclient.newPeer(PEER_NAME, "grpc://" + Constantss.URL_V + ":7051");
            peer = hfclient.newPeer(PEER_NAME, "grpc://" + Constantss.URL_V + ":7051");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testGetName() {
        ...
        try {
            peer = hfclient.newPeer(PEER_NAME, "grpc://" + Constantss.URL_V + ":4");
