...
public class EndpointTest {
    ...
    public void testEndpointNonPEM() {
        Endpoint ep = new Endpoint("grpc://" + Constantss.URL_V + ":524", null);
        Assert.assertEquals("" + Constantss.URL_V + "", ep.getHost());
        Assert.assertEquals(524, ep.getPort());

        ep = new Endpoint("grpcs://" + Constantss.URL_V + ":524", null);
        Assert.assertEquals("" + Constantss.URL_V + "", ep.getHost());

        try {
            new Endpoint("grpcs2://" + Constantss.URL_V + ":524", null);
        ...
        try {
            new Endpoint("grpcs://" + Constantss.URL_V + "", null);
            Assert.fail("should have thrown error as there is no port in the url");
        } catch (RuntimeException rex) {
            Assert.assertEquals("URL must be of the format protocol://host:port. Found: 'grpcs://" + Constantss.URL_V + "'", rex.getMessage());
        }
    ...
    public void testNullPropertySslProvider() {
        ...
        new Endpoint("grpcs://" + Constantss.URL_V + ":594", testprops);
    }
    ...
    public void testExtractCommonName() {
        ...
        Assert.assertSame(new Endpoint("grpcs://" + Constantss.URL_V + ":594", testprops).getClass(), Endpoint.class);
    }
    ...
    public void testBadClientKeyFile() {
        thrown.expect(RuntimeException.class);
        thrown.expectMessage("Failed endpoint grpcs://" + Constantss.URL_V + ":594 to parse TLS client private key");
    ...
    public void testBadClientCertFile() {
        thrown.expect(RuntimeException.class);
        thrown.expectMessage("Failed endpoint grpcs://" + Constantss.URL_V + ":594 to parse TLS client certificate");
    ...
    public void testClientTLSInvalidProperties() {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("Failed endpoint grpcs://" + Constantss.URL_V + ":594 to parse TLS client private key"));
        }
    }
    ...
    public void testClientTLSProperties() {
        ...
        testprops.setProperty("clientKeyFile", System.getProperty("user.dir") + "/src/test/resources/tls-client.key");
        testprops.setProperty("clientCertFile", System.getProperty("user.dir") + "/src/test/resources/tls-client.crt");
        Endpoint endpoint = new Endpoint("grpcs://" + Constantss.URL_V + ":594", testprops);
    ...
    public void testClientTLSCACertProperties() throws Exception {
        ...
        TEndpoint endpoint = new TEndpoint("grpcs://" + Constantss.URL_V + ":594", testprops);
