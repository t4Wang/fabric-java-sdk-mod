...
public class ChannelTest {
    ...
    public static void setupClient() {
        ...
        try {
            ...
            shutdownChannel.addOrderer(hfclient.newOrderer("shutdow_orderer", "grpc://" + Constantss.URL_V + ":99"));

            setField(shutdownChannel, "shutdown", true);

            throwOrderer = new Orderer("foo", "grpc://" + Constantss.URL_V + ":8", null) {
    ...
    public void testChannelAddPeer() throws Exception {
        ...
        final Peer peer = hfclient.newPeer("peer_", "grpc://" + Constantss.URL_V + ":7051");
    ...
    public void testChannelAddOrder() throws Exception {
        ...
        final Orderer orderer = hfclient.newOrderer("testorder", "grpc://" + Constantss.URL_V + ":7051");
    ...
    public void testChannelAddNoNamePeer() {
        ...
        try {
            ...
            testChannel = new Channel(CHANNEL_NAME, hfclient);
            final Peer peer = hfclient.newPeer(null, "grpc://" + Constantss.URL_V + ":7051");
...
//    }
    ...
    public void testChannelBadPeerDoesNotBelong() throws Exception {
        ...
        Collection<Peer> peers = Arrays.asList((Peer[]) new Peer[] {hfclient.newPeer("peer2", "grpc://" + Constantss.URL_V + ":22")});
    ...
    public static Channel createRunningChannel(String channelName, Collection<Peer> peers) throws InvalidArgumentException, NoSuchFieldException, IllegalAccessException {
        ...
        if (peers == null) {
            Peer peer = hfclient.newPeer("peer1", "grpc://" + Constantss.URL_V + ":22");
            channel.addPeer(peer);
            channel.addOrderer(hfclient.newOrderer("order1", "grpc://" + Constantss.URL_V + ":22"));
        } else {
            for (Peer peer : peers) {
                channel.addPeer(peer);
    ...
    public void testChannelPeerJoinNoOrderer() throws Exception {
        ...
        channel.joinPeer(hfclient.newPeer("peerJoiningNOT", "grpc://" + Constantss.URL_V + ":22"));
    ...
    public void testNOf() throws Exception {
        ...
        Peer peer1Org1 = new Peer("peer1Org1", "grpc://" + Constantss.URL_V + ":9", null);
        Peer peer1Org12nd = new Peer("org12nd", "grpc://" + Constantss.URL_V + ":9", null);
        Peer peer2Org2 = new Peer("peer2Org2", "grpc://" + Constantss.URL_V + ":9", null);
        Peer peer2Org22nd = new Peer("peer2Org22nd", "grpc://" + Constantss.URL_V + ":9", null);
